...
def accel_2body(state: StateVector, t: float, env: Environment) -> Vec3:
...
def accel_j2(state: StateVector, t: float, env: Environment) -> Vec3:
...
def gravity(state: StateVector, t: float, env: Environment) -> Vec3:
